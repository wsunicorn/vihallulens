...
| 19/08 | T07 | Chưa chốt được dùng float16 hay float32: float16 nhanh hơn nhiều nhưng chưa biết 27 lớp còn sống có bị bóp méo không, và mới thử đúng hai mẫu | Viết `scripts/compare_dtypes.py` chạy cả hai kiểu số trên 20 mẫu trải từ 47 tới 4.805 từ, báo tỷ lệ nan và sai lệch theo từng lớp. Chờ kết quả rồi mới sửa quyết định trong `CLAUDE.md` |
